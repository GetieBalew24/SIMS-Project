<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="SIS_View.Department" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_department" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="departmentCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_department_RowCancelingEdit" OnRowDeleting="Gv_department_RowDeleting" OnRowEditing="Gv_department_RowEditing" OnRowUpdating="Gv_department_RowUpdating" OnRowCommand="Gv_department_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_department_RowDataBound" OnSelectedIndexChanged="Gv_department_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="collegeCode">
                ...
                <EditItemTemplate>
                    <asp:DropDownList ID="ddlCollegeCode" runat="server" DataSourceID="SqlDataSource1" DataTextField="collegeName" DataValueField="collegeCode" Font-Size="XX-Small">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SISConnectionString %>" SelectCommand="RetriveUniqueCollege" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:DropDownList ID="insCollegeCode" runat="server" DataSourceID="SqlDataSource1" DataTextField="collegeName" DataValueField="collegeCode" Font-Size="XX-Small" Visible="False">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SISConnectionString %>" SelectCommand="RetriveUniqueCollege" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </FooterTemplate>
                 
                <ItemTemplate>
                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("collegeCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="departmentCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("departmentCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="departmentName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtDepartmentName" runat="server" Font-Size="XX-Small" Text='<%# Eval("departmentName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insDepartmentName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
