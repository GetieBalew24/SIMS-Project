<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="AdmissionClassification.aspx.cs" Inherits="SIS_View.AdmissionClassification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_admissionClassification" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="admissionClassificationCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_admissionClassification_RowCancelingEdit" OnRowDeleting="Gv_admissionClassification_RowDeleting" OnRowEditing="Gv_admissionClassification_RowEditing" OnRowUpdating="Gv_admissionClassification_RowUpdating" OnRowCommand="Gv_admissionClassification_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_admissionClassification_RowDataBound" OnSelectedIndexChanged="Gv_admissionClassification_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="admissionClassificationCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("admissionClassificationCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("admissionClassificationCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="admissionClassificationName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtAdmissionClassificationName" runat="server" Font-Size="XX-Small" Text='<%# Eval("admissionClassificationName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insAdmissionClassificationName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("admissionClassificationName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
