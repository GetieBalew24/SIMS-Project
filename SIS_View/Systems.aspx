<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="Systems.aspx.cs" Inherits="SIS_View.Systems" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_system" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="systemCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_system_RowCancelingEdit" OnRowDeleting="Gv_system_RowDeleting" OnRowEditing="Gv_system_RowEditing" OnRowUpdating="Gv_system_RowUpdating" OnRowCommand="Gv_system_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_system_RowDataBound" OnSelectedIndexChanged="Gv_system_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="systemCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("systemCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("systemCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="systemName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtSystemName" runat="server" Font-Size="XX-Small" Text='<%# Eval("systemName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insSystemName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("systemName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
