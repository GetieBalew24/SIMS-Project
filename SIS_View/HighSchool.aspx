<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="HighSchool.aspx.cs" Inherits="SIS_View.HighSchool" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <asp:GridView ID="Gv_highSchool" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="highSchoolCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_highSchool_RowCancelingEdit" OnRowDeleting="Gv_highSchool_RowDeleting" OnRowCommand="Gv_highSchool_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_highSchool_RowDataBound" OnSelectedIndexChanged="Gv_highSchool_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="highSchoolCode" SortExpression="highSchoolCode">
                <EditItemTemplate>
                    <asp:Label ID="Label23" runat="server" Text='<%# Eval("highSchoolCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("highSchoolCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="woredaCode" SortExpression="woredaCode">
                <FooterTemplate>
                    <asp:DropDownList ID="insWoredaCode" runat="server" DataSourceID="SqlDataSource1" DataTextField="woredaName" DataValueField="woredaCode" Font-Size="XX-Small" Visible="False">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SISConnectionString %>" SelectCommand="RetriveUniqueWoreda" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label19" runat="server" Text='<%# Eval("woredaCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="highSchoolName" SortExpression="highSchoolName">
                <FooterTemplate>
                    <asp:TextBox ID="insHighSchoolName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label18" runat="server" Text='<%# Eval("highSchoolName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
