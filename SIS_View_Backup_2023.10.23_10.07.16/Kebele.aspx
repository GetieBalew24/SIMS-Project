<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="Kebele.aspx.cs" Inherits="SIS_View.Kebele" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_kebele" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="kebeleCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_kebele_RowCancelingEdit" OnRowDeleting="Gv_kebele_RowDeleting" OnRowCommand="Gv_kebele_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_kebele_RowDataBound" OnSelectedIndexChanged="Gv_kebele_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="kebeleCode" SortExpression="kebeleCode">
                <EditItemTemplate>
                    <asp:Label ID="Label23" runat="server" Text='<%# Eval("kebeleCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("kebeleCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="kebeleName" SortExpression="kebeleName">
                <FooterTemplate>
                    <asp:TextBox ID="insKebeleName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label18" runat="server" Text='<%# Eval("kebeleName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
