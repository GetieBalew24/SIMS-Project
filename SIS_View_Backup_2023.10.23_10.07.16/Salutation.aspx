<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="Salutation.aspx.cs" Inherits="SIS_View.Salutation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_salutation" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="salutationCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_salutation_RowCancelingEdit" OnRowDeleting="Gv_salutation_RowDeleting" OnRowEditing="Gv_salutation_RowEditing" OnRowUpdating="Gv_salutation_RowUpdating" OnRowCommand="Gv_salutation_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_salutation_RowDataBound" OnSelectedIndexChanged="Gv_salutation_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="salutationCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("salutationCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("salutationCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="salutationName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtSalutationName" runat="server" Font-Size="XX-Small" Text='<%# Eval("salutationName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insSalutationName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("salutationName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
