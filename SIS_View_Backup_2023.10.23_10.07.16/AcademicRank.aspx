<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="AcademicRank.aspx.cs" Inherits="SIS_View.AcademicRank" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_academicRank" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="academicRankCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_academicRank_RowCancelingEdit" OnRowDeleting="Gv_academicRank_RowDeleting" OnRowEditing="Gv_academicRank_RowEditing" OnRowUpdating="Gv_academicRank_RowUpdating" OnRowCommand="Gv_academicRank_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_academicRank_RowDataBound" OnSelectedIndexChanged="Gv_academicRank_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="academicRankCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("academicRankCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("academicRankCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="academicRankName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtAcademicRankName" runat="server" Font-Size="XX-Small" Text='<%# Eval("academicRankName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insAcademicRankName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("academicRankName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
