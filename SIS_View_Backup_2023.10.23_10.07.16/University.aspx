<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="University.aspx.cs" Inherits="SIS_View.University" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_university" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="universityCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_university_RowCancelingEdit" OnRowDeleting="Gv_university_RowDeleting" OnRowEditing="Gv_university_RowEditing" OnRowUpdating="Gv_university_RowUpdating" OnRowCommand="Gv_university_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_university_RowDataBound" OnSelectedIndexChanged="Gv_university_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC" AllowPaging="True">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="universityCode" SortExpression="universityCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("universityCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("universityCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="universityName" SortExpression="universityName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtUniversityName" runat="server" Font-Size="XX-Small" Text='<%# Eval("universityName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insUniversityName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("universityName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
