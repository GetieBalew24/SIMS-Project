<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="Staffcategory.aspx.cs" Inherits="SIS_View.Staffcategory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <asp:GridView ID="Gv_staffCategory" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="staffCategoryCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_staffCategory_RowCancelingEdit" OnRowDeleting="Gv_staffCategory_RowDeleting" OnRowEditing="Gv_staffCategory_RowEditing" OnRowUpdating="Gv_staffCategory_RowUpdating" OnRowCommand="Gv_staffCategory_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_staffCategory_RowDataBound" OnSelectedIndexChanged="Gv_staffCategory_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="staffCategoryCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("staffCategoryCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("staffCategoryCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="staffCategoryName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtStaffCategoryName" runat="server" Font-Size="XX-Small" Text='<%# Eval("staffCategoryName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insStaffCategoryName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("staffCategoryName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
