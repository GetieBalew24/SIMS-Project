<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="CreateAccount.aspx.cs" Inherits="SIS_View.CreateAccount" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
	<asp:RadioButton ID="RadioButton1" GroupName="language" runat="server" Text="Those who have Account" />
    <br />
    <asp:RadioButton ID="RadioButton2" GroupName="language" runat="server" Text="those who do not have account"/>
    <br />
    ...
    <asp:GridView ID="Gv_staff" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="staffId" Font-Size="XX-Small" OnRowCancelingEdit="Gv_staff_RowCancelingEdit" OnRowDeleting="Gv_staff_RowDeleting" OnRowEditing="Gv_staff_RowEditing" OnRowUpdating="Gv_staff_RowUpdating" OnRowCommand="Gv_staff_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_staff_RowDataBound" OnSelectedIndexChanged="Gv_staff_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="phone" SortExpression="phone">
                <EditItemTemplate>
                    <asp:TextBox ID="txtPhone" runat="server" Font-Size="XX-Small" Text='<%# Eval("phone") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insPhone" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="email" SortExpression="email">
                <EditItemTemplate>
                    <asp:TextBox ID="txtEmail" runat="server" Font-Size="XX-Small" Text='<%# Eval("email") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insEmail" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
