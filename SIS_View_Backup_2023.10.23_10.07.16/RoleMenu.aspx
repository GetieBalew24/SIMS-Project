<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="RoleMenu.aspx.cs" Inherits="SIS_View.RoleMenu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:GridView ID="Gv_roleMenu" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="roleMenuCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_roleMenu_RowCancelingEdit" OnRowDeleting="Gv_roleMenu_RowDeleting"  OnRowCommand="Gv_roleMenu_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_roleMenu_RowDataBound" OnSelectedIndexChanged="Gv_roleMenu_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="roleMenuCode" SortExpression="roleMenuCode">
                <EditItemTemplate>
                    <asp:Label ID="Label23" runat="server" Text='<%# Eval("roleMenuCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("roleMenuCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="menuCode" SortExpression="menuCode">
                <FooterTemplate>
                    <asp:DropDownList ID="insMenuCode" runat="server" DataSourceID="SqlDataSource1" DataTextField="menuName" DataValueField="menuCode" Font-Size="XX-Small" Visible="False">
                    </asp:DropDownList>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label20" runat="server" Text='<%# Eval("menuCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
