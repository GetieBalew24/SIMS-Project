<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="SIS_View.Menu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_menu" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="menuCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_menu_RowCancelingEdit" OnRowDeleting="Gv_menu_RowDeleting" OnRowEditing="Gv_menu_RowEditing" OnRowUpdating="Gv_menu_RowUpdating" OnRowCommand="Gv_menu_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_menu_RowDataBound" OnSelectedIndexChanged="Gv_menu_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC" AllowPaging="True" PageSize="5">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="menuCode" SortExpression="menuCode">
                <EditItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("menuCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("menuCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="parentCode" SortExpression="parentCode">
                <EditItemTemplate>
                    <asp:DropDownList ID="ddlParentCode" runat="server" DataSourceID="SqlDataSource1" DataTextField="menuName" DataValueField="menuCode" Font-Size="XX-Small">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SISConnectionString %>" SelectCommand="RetriveUniqueMenus" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:DropDownList ID="insParentCode" runat="server" DataSourceID="SqlDataSource1" DataTextField="menuName" DataValueField="menuCode" Font-Size="XX-Small" Visible="False">
                        <asp:ListItem Value="0">Root</asp:ListItem>
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SISConnectionString %>" SelectCommand="RetriveUniqueMenus" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("parentCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="menuName" SortExpression="menuName">
                <EditItemTemplate>
                    <asp:TextBox ID="txtMenuName" runat="server" Font-Size="XX-Small" Text='<%# Eval("menuName") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insMenuName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("menuName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="menuLink" SortExpression="menuLink">
                <EditItemTemplate>
                    <asp:TextBox ID="txtMenuLink" runat="server" Font-Size="XX-Small" Text='<%# Eval("menuLink") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="insMenuLink" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label18" runat="server" Text='<%# Eval("menuLink") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
