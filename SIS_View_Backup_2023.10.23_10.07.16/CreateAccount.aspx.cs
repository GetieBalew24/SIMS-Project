...
namespace SIS_View
{
    public partial class CreateAccount : System.Web.UI.Page
    {
        ...
        protected void Gv_staff_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string username = Gv_staff.SelectedDataKey.Value.ToString();
            if (sis.AddUserAccounts(username, "Staff", "superadmin"))
            {
                LoadStaff();
                lblmsg.Text = "<b>Account created for -->     " + username + "</b>";
            }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                TBL_haveAccount[] staff = sis.GetHaveStaffAccounts();
                dt.Columns.Add("staffId");
                dt.Columns.Add("salutationCode");
                dt.Columns.Add("firstName");
                dt.Columns.Add("fathername");
            ...
            {
                TBL_notHaveAccount[] staff = sis.GetNotHaveStaffAccounts();
                dt.Columns.Add("staffId");
                dt.Columns.Add("salutationCode");
                dt.Columns.Add("firstName");
                dt.Columns.Add("fathername");
