<%@ Page Title="" Language="C#" MasterPageFile="~/SIS.Master" AutoEventWireup="true" CodeBehind="Ethinic.aspx.cs" Inherits="SIS_View.Ethinic" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="Gv_ethinic" runat="server" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" GridLines="None" DataKeyNames="ethinicCode" Font-Size="XX-Small" OnRowCancelingEdit="Gv_ethinic_RowCancelingEdit" OnRowDeleting="Gv_ethinic_RowDeleting" OnRowCommand="Gv_ethinic_RowCommand" ShowFooter="True" EmptyDataText="No Records Display" ShowHeaderWhenEmpty="True" AllowCustomPaging="True" AllowSorting="True" OnRowDataBound="Gv_ethinic_RowDataBound" OnSelectedIndexChanged="Gv_ethinic_SelectedIndexChanged" BorderWidth="1px" BorderColor="#CCCCCC">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ethinicCode" SortExpression="ethinicCode">
                <EditItemTemplate>
                    <asp:Label ID="Label23" runat="server" Text='<%# Eval("ethinicCode") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("ethinicCode") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="ethinicName" SortExpression="ethinicName">
                <FooterTemplate>
                    <asp:TextBox ID="insEthinicName" runat="server" Font-Size="XX-Small" Visible="False"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label18" runat="server" Text='<%# Eval("ethinicName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
